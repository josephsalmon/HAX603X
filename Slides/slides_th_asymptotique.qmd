...
Soient $X$ et $Y$ des v.a. de densités $f$ et $g$ respectivement,
la densité de $X+Y$ est donnée par la convolution $f*g$.
::::

## Convolution et TCL
Pour $X_1, \dots, X_n$, i.i.d., de densité $f$, on affiche la loi de $\bar{X}_n$.
