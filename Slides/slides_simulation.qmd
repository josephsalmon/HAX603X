...
Suppons $A\subset B \subset \mathbb{R}^d$, deux ensembles mesureables pour la mesure de Lebesgue.
...
<br>
Dans l'exemple précédent, on voir qu'on a pu appliquer la méthode de rejet sans la connaissance de $m$.

<br>

Ce point est important: parfois la connaissance de $m$ est difficile à obtenir, et il est préférable de ne pas l'utiliser (notamment quand les constantes de normalisation des densités sont difficiles à calculer).
