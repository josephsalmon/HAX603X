...
## {#enseignants data-menu-title="Enseignants"}

[{{< fa graduation-cap title="graduation cap" >}} Enseignants]{.slide-title}
...
## {#ressources data-menu-title="Ressources en ligne"}

[{{< fa globe title="laptop code" >}} Ressources en ligne]{.slide-title}
...
## {#validation data-menu-title="Validation"}

[{{< fa globe title="laptop code" >}} Validation]{.slide-title}
