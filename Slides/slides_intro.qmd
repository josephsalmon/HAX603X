...
- Bases de probabilités [@Foata_Fuchs96,@Barbe_Ledoux06]: probabilité, densité, espérance, fonction de répartition, mesures
...
- Méthodes de génération aléatoire (inverse, rejet, etc.)
- Réduction de variance, enjeux computationnels
- Rappels sur les lois gaussiennes
