...
Notons $E$ l'erreur de la méthode de Riemann, est donnée par $E = |\int_{\Omega} f(x)dx - \widehat{I}^{\mathrm{R}}|$, et on alors:
...
& = L_f \sum_{i_1=1}^m \cdots \sum_{i_d=1}^m  \int_{{\Omega}_{i_1,\dots,i_d}} \|x - \omega_{i_1,\dots,i_d}\|_{\infty} dx \\
\end{align*}

Pour $x\in \Omega_{i_1,\dots,i_d}$, alors $\|x-\omega_{i_1,\dots,i_d}\|\leq \max_{j = 1,\dots, d}\tfrac{b_j-a_j}{m}=\tfrac{1}{m}\|b-a\|_{\infty}$, et donc:
...
& \leq \frac{L_f\mathrm{Vol}(\Omega)\|b-a\|_{\infty}}{n^{\tfrac{1}{d}}} \\
\end{align*}
