...
%--------------------------------------------
            \cor{
                ...
                \begin{equation*}
                    ...
                    \frac{I_n (1 - I_n)}{n} \approx \frac{0.126}{n}
                \end{equation*}
            }
%--------------------------------------------
...
%-----------------------
            \cor{
                La variance se trouve très facilement
                \begin{equation*}
                    \mbox{Var}(I_n) = \frac{d^2}{4 \ell^2} \frac{I(1 -
                    I)}{n},
                \end{equation*}
...
%-----------------------
            \cor{
                Lorsque $\ell = d$, un estimateur de $\pi$ est alors
                \begin{equation*}
