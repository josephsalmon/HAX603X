...
\begin{exo}{}
	...
	\[
	B (x,y) = \int_0^1 t^{x-1} (1-t)^{y-1} \, \mathrm dt\,.
	\]
...
\begin{exo}{}
	...
	\cor{1. Le calcul de la fonction de répartition ne pose pas de problème :
	\[
	F_X(x)
	=
	...
	2. Pour la méthode de rejet, on choisit une densité uniforme $g$ sur $[-1,1]$ qui vérifie
	\[
