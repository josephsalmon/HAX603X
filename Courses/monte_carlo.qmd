...
Supposons que l'on veuille calculer $I=\int_0^1 e^{x^2} dx \simeq 1.46265\dots$ à l'aide de la loi uniforme sur $[0,1]$. Comme au voisinage de $0$, on a $e^{x^2}\simeq 1+x^2$, on propose de prendre $h(x)=1+x^2$. On a alors 
$$
