...
$$
où $F^{-1}_{\cN(0,1)}$ est la fonction quantile^[c'est-à-dire l'inverse de la fonction de répartition] de la loi normale centrée réduite et 
$$
	S_n^2=\frac{1}{n-1}\sum_{i=1}^n\big(g(X_i)-I_n\big)^2
$$
est l'estimateur sans biais^[Ceci signifie que $\mathbb E[S_n^2]=\var(g(X))$] de la variance empirique.
::::
