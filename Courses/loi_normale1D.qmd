...
statisticien et chimiste anglais. Alors qu'il était employé à la brasserie Guinness à Dublin. Son employeur lui refusant le droit de publier sous son propre nom, W. Gosset choisit un pseudonyme, *Student* (&#x1F1EB;&#x1F1F7;: étudiant).
...
$$
	f_{(X,Y)}(x,y) = \dfrac{1}{\sqrt{2 \pi}} e^{-x^2/2} \dfrac{1}{2^{\frac{k}{2}2} \Gamma(k/2)} y^{\frac{k}{2}-1} e^{-y/2} {1\hspace{-3.8pt} 1}_{]0, \infty[}(y)\, \quad x,y \in \mathbb{R}\,.
$$
...
$$
	f_{(U,V)}(u,v)
	= \dfrac{1}{\sqrt{2 \pi}} e^{-u^2/2} \dfrac{1}{2^{k/2} \Gamma(k/2)} \bigg(\dfrac{k u^2}{v^2}\bigg)^{\frac{k}{2}-1} e^{-\frac{1}{2} \frac{k u^2}{v^2}} \dfrac{2 k u^2}{(v^2)^{3/2}} {1\hspace{-3.8pt} 1}_{\mathbb{R}^*}(v)\,.
$$
...
$$
	f_V(v)
	=
	\dfrac{1}{\sqrt{2 \pi}} \dfrac{1}{2^{k/2} \Gamma(k/2)} \bigg(\dfrac{k}{v^2}\bigg)^{\frac{k}{2}-1} \dfrac{2 k}{(v^2)^{3/2}}
...
$$
\begin{align*}
\bigg(\dfrac{k}{v^2}\bigg)^{\frac{k}{2}-1} \dfrac{k}{(v^2)^{3/2}}
