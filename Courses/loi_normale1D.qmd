...
fonction caractéristique d'une variable aléatoire $X \sim \mathcal{N}(\mu, \nu)$ est donnée pour tout $t \in \mathbb{R}$ par
$$
\begin{align*}
...
On obtient ainsi une autre manière de simuler une loi de Cauchy, en simulant deux gaussiennes indépendantes et en prennant leur ratio.
