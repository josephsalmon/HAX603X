...
fig.add_trace(
    go.Scatter(x=borders_red[:,0], y=borders_red[:,1], mode='lines', line=dict(width=1), marker=dict(color='red'), name="Avec intersection"),
    row=1,
    col=1
)
fig.add_trace(
    go.Scatter(x=borders_blue[:,0], y=borders_blue[:,1], mode='lines', line=dict(width=1), marker=dict(color='lightblue'), name="Sans intersection"),
    row=1,
    col=1
)
...
fig.add_trace(go.Scatter(x=n_samples_array, y=pi_estimate, mode='lines', line=dict(width=1), marker=dict(color='red'), showlegend=False),
    row=2,
    col=1
)

fig.add_annotation(dict(x=1.2, y=0.18, xref="paper", yref="paper", 
