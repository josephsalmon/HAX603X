...
var trace1 = {
        ...
        y: zeros.slice(0, n_samples),
        mode: 'markers',
        type: 'scatter',
        marker: {
            color: samples.slice(0, n_samples).map((x) => x > 0 ? 'blue' : 'red'),
            size: 5,
        },
...
Les marches aléatoires, comme tous les processus à valeurs discrètes, ont une représentation graphique naturelle. On représente graphiquement un tirage de la marche $(S_n)_{n\in\N}$ sur l'intervalle de temps $\llbracket 0,N \rrbracket$ par une ligne brisée joignant les points $(0,S_0)$, $(1,S_1)$, \dots,$(N,S_N)$. On a donc en abscisse le temps, et en ordonnée la valeur de la marche, cf. @fig:chap03-traj
