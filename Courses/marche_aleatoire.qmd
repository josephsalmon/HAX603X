...
![](../srcimages/deux_chemins.svg){width=50%}
...
![](../srcimages/reflex.svg){width=80%}

Réflexion: un chemin de $(0,2)$ à $(11,1)$ passant par 0 (trait bleu) et son image (tirets rouges) par la symétrie de premier passage en 0.
:::
...
&=\frac{1}{2}\P(T_a\wedge T_b=+\infty|S_0=x) \enspace,
\end{align*}
