...
La figure XXX présente deux chemins de $(1,1)$ à $(5,3)$.
...
::: {.proof}
Le principe est de construire une bijection entre les deux ensembles de chemins pour prouver qu'ils ont le même cardinal. Pour cela, on exploite la symétrie de la marche, comme illustré figure XXX.
